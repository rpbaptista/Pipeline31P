...
if __name__ == '__main__':
    ...
    if (args.alignAnat == 1):
        print("-Register with anatomy-")
        calc_coreg_imgs(anat_31P_path, output_filter_path_PCr, '/neurospin/ciclops/people/Renata/Codes/Pipeline31P/output/pcr_toanat.mat')
#        calc_coreg_imgs(anat_31P_path, output_filter_path_PCr, '/neurospin/ciclops/people/Renata/Codes/Pipeline31P/output/pcr_toanat.mat')
